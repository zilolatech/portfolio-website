  ...
  return (
    <div className='absolute z-20 ml-32 mt-16 h-[85%] w-[36%] bg-primary'>
            ...
            <div className='flex ml-6 pt-3'>
              <img src='./images/typing-speed-test.png' className='h-40 rounded'></img>
            ...
            <div className='flex ml-6 my-8'>
              ...
              <img src='./images/e-shop.png' className='h-40 ml-16 rounded'></img>
            </div>
            <div className='flex ml-6'>
              <img src='./images/snake-game.jpg' className='h-40 rounded-2xl'></img>
              <div className='ml-5 mt-2'>
